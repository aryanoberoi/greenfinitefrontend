...
const Footer = () => {
  ...
  return (
    <footer className="font-inter bg-offwhite text-amber-800 py-1 px-4 sm:px-6 lg:px-8 flex flex-col justify-center min-h-[1px]" style={{fontFamily: 'var(--font-primary) !important'}}>
